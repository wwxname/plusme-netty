...
import com.plusme.rope.tomcat.threads.ThreadPoolExecutor;
import com.plusme.rope.tomcat.net.AbstractEndpoint.Acceptor.AcceptorState;
import com.plusme.rope.tomcat.ExceptionUtils;
import com.plusme.rope.tomcat.IntrospectionUtils;
import com.plusme.rope.tomcat.collection.SynchronizedStack;
import com.plusme.rope.tomcat.res.StringManager;
import com.plusme.rope.tomcat.threads.LimitLatch;
import com.plusme.rope.tomcat.threads.ResizableExecutor;
import com.plusme.rope.tomcat.threads.TaskQueue;
import com.plusme.rope.tomcat.threads.TaskThreadFactory;
...
public abstract class AbstractEndpoint<S> {
    ...
    public void setAttribute(String name, Object value) {
        if (log.isTraceEnabled()) {
            log.trace(sm.getString("endpoint.setAttribute", name, value));
        }
    ...
    public Object getAttribute(String key) {
        ...
        if (log.isTraceEnabled()) {
            log.trace(sm.getString("endpoint.getAttribute", key, value));
        }
        return value;
    }
            ...
            if (executor instanceof ThreadPoolExecutor) {
                ...
                if (timeout > 0) {
                    ...
                    if (tpe.isTerminating()) {
                       log.warn(sm.getString("endpoint.warn.executorShutdown", getName()));
                    }
                }
    ...
    public boolean processSocket(SocketWrapperBase<S> socketWrapper,
        ...
        try {
            ...
            if (dispatch && executor != null) {
                System.err.println("提交任务为 "+sc.socketWrapper);
                System.err.println("提交channel "+sc.socketWrapper.getSocket());
                executor.execute(sc);
            } else {
                sc.run();
            }
    ...
    protected long countDownConnection() {
        ...
        if (latch!=null) {
            ...
            if (result<0) {
                log.warn(sm.getString("endpoint.warn.incorrectConnectionCount"));
            }
            return result;
        } else return -1;
    }
