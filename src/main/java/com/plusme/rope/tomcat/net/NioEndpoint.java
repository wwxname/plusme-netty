...
import com.plusme.rope.tomcat.net.AbstractEndpoint.Handler.SocketState;
...
public class NioEndpoint extends AbstractJsseEndpoint<NioChannel> {
    ...
    public void bind() throws Exception {
        ...
        serverSock.socket().setSoTimeout(2000000);
            ...
            while (running) {
                ...
                try {
                    ...
                    try {
                        ...
                        System.err.println("#################### Acceptor 收到一个连接");
        ...
        public void run() {
            ...
            while (true) {
                ...
                try {
                    ...
                    if (keyCount > 0)
                        System.err.println("###########Poller 收到一个读写事件 ");
                    if (close) {
                        events();
                        timeout(0, false);
                        try {
